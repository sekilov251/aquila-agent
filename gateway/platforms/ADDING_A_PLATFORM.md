...
There are two ways to add a platform to the Aquila gateway:
...
**zero changes to core Aquila code**.
...
Checklist for integrating a platform directly into the Aquila core.
