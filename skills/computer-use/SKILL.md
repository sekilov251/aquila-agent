...
Aquila drives [cua-driver](https://github.com/trycua/cua) under the hood
for the platform plumbing. The Aquila-side `computer_use` tool exposed
in this skill is a higher-level Aquila vocabulary; the raw cua-driver
...
Aquila intentionally keeps THIS skill focused on the Aquila-side
...
When `cua-driver skills install` autodetects Aquila (planned follow-up
