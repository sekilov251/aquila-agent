...
# Aquila Desktop Plugins Skill

Write plugins for the Aquila desktop app: statusbar items, layout panes,
...
- The Aquila desktop app (it loads plugins; the CLI/gateway alone does not).
