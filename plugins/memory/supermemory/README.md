...
it groups Aquila-written memories into a dedicated "Aquila" Space in the
...
Use `{identity}` in the `container_tag` to scope memories per Aquila profile:
