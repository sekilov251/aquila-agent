import type { AquilaGitWorktree } from '@/global'
 ...
 * repo shows its branches/worktrees even when they have no Aquila sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: AquilaGitWorktree[]
): SidebarSessionGroup[] {
