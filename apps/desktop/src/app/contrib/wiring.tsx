...
import { useAquilaConfig } from '../session/hooks/use-hermes-config'
...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  const { refreshAquilaConfig, sttEnabled, voiceMaxRecordingSeconds } = useAquilaConfig({
    activeSessionIdRef,
  ...
  useEffect(() => {
    ...
    void refreshAquilaConfig(true)
    void refreshActiveProfile()
  }, [activeGatewayProfile, refreshCurrentModel, refreshAquilaConfig])
