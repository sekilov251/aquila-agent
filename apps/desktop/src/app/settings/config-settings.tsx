...
import { getElevenLabsVoices, getAquilaConfigSchema, saveAquilaConfig } from '@/hermes'
import { useI18n } from '@/i18n'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import type { ConfigFieldSchema, AquilaConfigRecord } from '@/types/hermes'

import { setAquilaConfigCache, useAquilaConfigRecord } from '../hooks/use-config-record'
...
export function voiceFieldVisible(key: string, config: AquilaConfigRecord): boolean {
...
export function ConfigSettings({
  ...
  const [config, setConfig] = useState<AquilaConfigRecord | null>(null)
  const { data: loadedConfig, isError: configLoadFailed, refetch: refetchConfig } = useAquilaConfigRecord()
  ...
  const updateConfig = (next: AquilaConfigRecord) => {
