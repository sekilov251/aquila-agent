...
import { getAquilaConfigDefaults, getAquilaConfigRecord, saveAquilaConfig } from '@/hermes'
...
export function SettingsView({ onClose, onConfigSaved, onMainModelChanged }: SettingsPageProps) {
  ...
  const exportConfig = async () => {
    try {
      const cfg = await getAquilaConfigRecord()
  ...
  const resetConfig = async () => {
    ...
    try {
      await saveAquilaConfig(await getAquilaConfigDefaults())
      triggerHaptic('success')
      onConfigSaved?.()
    } catch (err) {
