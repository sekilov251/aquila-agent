...
import type { ConfigFieldSchema, AquilaConfigRecord, ToolsetInfo } from '@/types/hermes'
...
export function getNested(obj: AquilaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AquilaConfigRecord, path: string, value: unknown): AquilaConfigRecord {
...
function personalityOptions(config: AquilaConfigRecord): string[] {
...
function commandProviderNames(config: AquilaConfigRecord, section: 'tts' | 'stt'): string[] {
