...
function ConnectedProviderRow({
  ...
  // Aquila can clear this provider's creds via the API.
  const canDisconnect = provider.disconnectable ?? provider.flow !== 'external'
  // External (CLI-managed) provider Aquila can't clear via the API, but ships a
...
export function ProvidersSettings({
  ...
  // Aquila never deletes creds another tool owns behind a silent API call.
