import type { AquilaReviewFile } from '@/global'
...
export function buildReviewFlatList(files: AquilaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AquilaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
