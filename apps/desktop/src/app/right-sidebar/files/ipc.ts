...
import type { AquilaReadDirEntry, AquilaReadDirResult } from '@/global'
...
export type ProjectTreeEntry = AquilaReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: AquilaReadDirEntry) {
...
async function filterIgnored(entries: AquilaReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<AquilaReadDirResult> {
