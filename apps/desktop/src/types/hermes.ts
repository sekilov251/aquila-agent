...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Aquila doesn't know how to remove it. */
...
export type AquilaConfigRecord = Record<string, unknown>
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Aquila, 'hub' = installed. */
 ...
 *  not Aquila); elsewhere, driver health from `cua-driver doctor`. `null`
