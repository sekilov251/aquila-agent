...
const AQUILA_GOLD = '#F5C518'
const GOLD_DEEP = '#C99E06'
const GOLD_CREAM = '#F7E9B4'

const goldTint = (pct: number) => `color-mix(in srgb, ${GOLD_DEEP} ${pct}%, #FFFFFF)`
const goldTintTransparent = (pct: number) => `color-mix(in srgb, ${GOLD_DEEP} ${pct}%, transparent)`

/**
 * Aquila Gold — canonical Aquila desktop identity. The palette keeps the
 * current glass geometry neutral, then lets rich satin lacquered gold
 * (#f5c518 tones) carry the accents.
 */
export const nousTheme: DesktopTheme = {
  name: 'nous',
  label: 'Aquila Gold',
  description: 'Satin lacquered gold with warm glass neutrals',
  colors: {
    background: '#FFFDF3',
    foreground: '#1A1710',
    card: '#FFFFFF',
    cardForeground: '#1A1710',
    muted: goldTint(6),
    mutedForeground: '#71684C',
    popover: '#FFFFFF',
    popoverForeground: '#1A1710',
    primary: AQUILA_GOLD,
    primaryForeground: '#201900',
    secondary: goldTint(8),
    secondaryForeground: '#322A12',
    accent: goldTint(12),
    accentForeground: '#2E260E',
    border: goldTintTransparent(26),
    input: goldTintTransparent(34),
    ring: GOLD_DEEP,
    midground: AQUILA_GOLD,
    composerRing: GOLD_DEEP,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#FBF5DF',
    sidebarBorder: goldTintTransparent(20),
    userBubble: goldTint(7),
    userBubbleBorder: goldTintTransparent(28)
  },
  darkColors: {
    background: '#151004',
    foreground: GOLD_CREAM,
    card: '#1D1707',
    cardForeground: GOLD_CREAM,
    muted: '#251D09',
    mutedForeground: '#C7B577',
    popover: '#211A08',
    popoverForeground: GOLD_CREAM,
    primary: AQUILA_GOLD,
    primaryForeground: '#201900',
    secondary: '#2C230B',
    secondaryForeground: '#EFDF9F',
    accent: '#3A2E0E',
    accentForeground: '#F7DE8B',
    border: '#403413',
    input: '#0F0B03',
    ring: AQUILA_GOLD,
    midground: AQUILA_GOLD,
    composerRing: AQUILA_GOLD,
    destructive: '#C0473A',
    destructiveForeground: '#FEF2F2',
    sidebarBackground: '#110D03',
    sidebarBorder: '#332909',
    userBubble: '#271F0A',
    userBubbleBorder: '#4E3F14'
  },
  typography: {
