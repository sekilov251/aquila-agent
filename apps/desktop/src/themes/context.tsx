...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  try {
    window.localStorage.setItem('aquila-boot-background', chromeBg)
    window.localStorage.setItem('aquila-boot-color-scheme', rendered)
  } catch {
...
/** Sync the desktop skin with the active Aquila backend theme on connect. */
