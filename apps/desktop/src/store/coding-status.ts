...
import type { AquilaGitWorktree, AquilaRepoStatus } from '@/global'
...
export const $repoStatus = atom<AquilaRepoStatus | null>(null)
...
export const $repoWorktrees = atom<AquilaGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<AquilaRepoStatus | null>
  seq: number
  target: string
}
