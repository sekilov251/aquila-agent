...
//
// Scope is always "uncommitted" — Aquila' flow is agent edits you review BEFORE
...
export const $reviewFiles = atom<AquilaReviewFile[]>([])
...
export const $reviewShipInfo = atom<AquilaReviewShipInfo>({ ghReady: false, pr: null })
...
export async function selectReviewFile(file: AquilaReviewFile): Promise<void> {
