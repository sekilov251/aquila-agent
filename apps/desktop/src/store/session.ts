...
function workspaceCwdKey(connection: AquilaConnection | null = $connection.get()): string {
...
export const $connection = atom<AquilaConnection | null>(null)
...
export const setConnection = (next: Updater<AquilaConnection | null>) => updateAtom($connection, next)
