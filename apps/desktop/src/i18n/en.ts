...
export const en: Translations = {
  ...
  boot: {
    ready: 'Aquila Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Aquila settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingAquilaDesktop: 'Starting Aquila Desktop…'
    },
    errors: {
      backgroundExited: 'Aquila background process exited.',
      backgroundExitedDuringStartup: 'Aquila background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Aquila backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateAquila: 'Update Aquila',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Aquila Desktop.',
    ...
    native: {
      ...
      inputBody: 'Aquila is waiting for your response.',
      turnDoneTitle: 'Aquila finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Aquila defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Aquila writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Aquila is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Aquila asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Aquila was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Aquila follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Aquila is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Aquila, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Aquila checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Aquila configuration...',
    ...
    gateway: {
      ...
      intro:
        'Aquila Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Aquila backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Aquila backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Aquila backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Aquila Cloud',
      cloudDesc: 'Sign in once to Aquila Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Aquila Cloud',
      cloudSignIn: 'Sign in to Aquila Cloud',
      cloudSignedIn: 'Signed in to Aquila Cloud',
      cloudNeedsSignIn: 'Sign in to Aquila Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Aquila Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Aquila Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Aquila Cloud',
      cloudSignedOutMessage: 'Cleared the Aquila Cloud session.',
      ...
      restartingMessage: 'Aquila Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Aquila ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Aquila runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Aquila at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Aquila builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Aquila to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Aquila to generate pets.',
      backgroundHint: 'You can close this — Aquila will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Aquila desktop' },
    ...
    hermesActiveSessions: (version, count) => `Aquila ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Aquila environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Aquila will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Aquila backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Aquila. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Aquila...',
    placeholderReconnecting: 'Reconnecting to Aquila…',
    ...
    attachUrlDesc: 'Aquila will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Aquila to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Aquila…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Aquila…',
    ...
    unsupportedMessage: 'This version of Aquila can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Aquila from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Aquila will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Aquila desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Aquila updater takes over in its own window and reopens Aquila automatically when it’s done. Please don’t reopen Aquila yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Aquila reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Aquila reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Aquila needs a one-time install',
    ...
    settingUpTitle: 'Setting up Aquila Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Aquila CLI or desktop instance is running. Stop any running Aquila instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Aquila Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Aquila is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Aquila…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Aquila',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Aquila at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Aquila connects automatically',
    ...
    authorizeThere: 'Authorize Aquila there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Aquila there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Aquila Desktop v${version}`,
      ...
      gatewayTitle: 'Aquila inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Aquila will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Aquila is restarting...',
      askRestart: 'Ask Aquila to restart the server',
      lookingRestart: taskId => `Aquila is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Aquila is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Aquila finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Aquila could not restart the server.',
      stillWorking:
        'Aquila is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Aquila is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Aquila gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Aquila won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Aquila needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Aquila needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Aquila Desktop to use Save Image.',
    restartToSaveImages: 'Restart Aquila Desktop to save images',
