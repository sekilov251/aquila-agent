# Aquila Agent Desktop

<p align="center">
  <img src="https://img.shields.io/badge/Platforms-macOS%20%C2%B7%20Windows%20%C2%B7%20Linux-F5C518?style=for-the-badge" alt="Platforms">
  <a href="../../LICENSE"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT"></a>
</p>

**The native desktop app for [Aquila Agent](../../README.md) — the self-improving AI agent from Savez.** Same agent, same skills, same memory as the CLI and gateway, in a polished native window — chat with streaming tool output, side-by-side previews, a file browser, voice, and settings, no terminal required. Available for **macOS, Windows, and Linux**.

<table>
<tr><td><b>Chat with the full agent</b></td><td>Streaming responses, live tool activity, structured tool summaries, and the same conversation history as every other Aquila surface.</td></tr>
<tr><td><b>Side-by-side previews</b></td><td>Render web pages, files, and tool outputs in a right-hand pane while you keep chatting.</td></tr>
<tr><td><b>File browser</b></td><td>Explore and preview the working directory without leaving the app.</td></tr>
<tr><td><b>Voice</b></td><td>Talk to Aquila and hear it back.</td></tr>
...
### Install with Aquila (recommended)

Already have the Aquila CLI? Just run:

```bash
hermes desktop
```

It builds and launches the GUI against your existing install — same config, keys, sessions, and skills. On first launch Aquila walks you through picking a provider and model; nothing else to configure.

### Prebuilt installers

Build installers locally with `npm run dist` in `apps/desktop` (see Packaging below).
...
first launch it can install the Aquila Agent runtime into `HERMES_HOME`
...
- **Aquila Agent** runs as a headless `hermes serve` process and exposes the
...
5. a system Python that can import the Aquila runtime
...
Desktop supports a managed local backend, explicit remote gateways, and Aquila
...
tccutil reset Microphone com.savez.aquila
```
...
> The default Aquila home on Windows is `%LOCALAPPDATA%\hermes`. Set the `HERMES_HOME` env var if you've relocated it.
...
Aquila Agent is developed by Savez. Based on the MIT-licensed Aquila Agent by Savez.
