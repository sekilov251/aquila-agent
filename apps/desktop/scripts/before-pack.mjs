 ...
 * product name (`Aquila`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *   '.../release/linux-unpacked/electron' -> '.../release/linux-unpacked/Aquila'
 *
 ...
 * (the mac-unpacked Aquila.app bundle) and Windows (win-unpacked), so we
