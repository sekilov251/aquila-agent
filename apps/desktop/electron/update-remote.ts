 ...
 *
 * A public install can end up with `origin=git@github.com:sekilov251/aquila-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/sekilov251/aquila-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/sekilov251/aquila-agent'
