 ...
 * bootstrap-runner.ts
 *
 * Drives apps/desktop's first-launch install of Aquila Agent by spawning
...
function downloadInstallScript(ref, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/sekilov251/aquila-agent/${ref}/scripts/${scriptName}`
