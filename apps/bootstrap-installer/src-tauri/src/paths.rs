...
//! Electron desktop's resolveAquilaHome() ALL use ~/.hermes on macOS — there
...
/// Returns the canonical Aquila home directory, respecting $HERMES_HOME if set.
pub fn hermes_home() -> PathBuf {
    ...
    {
        // %LOCALAPPDATA%\hermes — matches scripts/install.ps1's $AquilaHome.
    ...
    // install.sh, and the Electron desktop's resolveAquilaHome()).
