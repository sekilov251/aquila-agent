...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Aquila' : 'Setting up Aquila Agent'

  const description = isUpdate
    ? 'Aquila is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Aquila installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
