...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  Aquila Agent  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to Aquila instantly when PRs are opened or updated.
:::
...
- **Aquila Agent installed** — see the [Installation guide](/getting-started/installation)
...
Make sure Aquila can access GitHub. Start a chat:
...
Still in the chat, ask Aquila to review a real PR:
...
A skill gives Aquila consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach Aquila your team's standards:
...
2. Teach Aquila your conventions via memory (Step 4)
