---
sidebar_position: 8
title: "Use Voice Mode with Aquila"
description: "A practical guide to setting up and using Aquila voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Aquila
...
- you want Aquila sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Aquila.
...
## Step 1: make sure normal Aquila works first
...
Aquila supports both local and cloud speech stacks.
...
If you choose NeuTTS in the setup wizard, Aquila checks whether `neutts` is already installed. If it is missing, the wizard tells you NeuTTS needs the Python package `neutts` and the system package `espeak-ng`, offers to install them for you, installs `espeak-ng` with your platform package manager, and then runs:
...
4. Aquila transcribes and responds
...
- asking Aquila to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Aquila loop.

## Tuning CLI behavior

### Silence threshold

If Aquila starts/stops too aggressively, tune:
...
Aquila stays a normal chat bot, but can speak replies.
...
- you want Aquila to function like a portable research or ops assistant
...
Aquila joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Aquila detects speech boundaries
- transcripts are posted in the associated text channel
- Aquila responds in text and audio
