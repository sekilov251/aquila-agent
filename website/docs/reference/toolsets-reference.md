...
description: "Reference for Aquila core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call Aquila tools programmatically. |
