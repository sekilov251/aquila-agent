...
- User wants **Aquila itself to drive a browser** → use Aquila' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
