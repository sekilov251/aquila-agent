...
| Version | `1.0.0` |
| Author | arceus77-7, enhanced by Aquila Agent |
| License | MIT |
...
- `tmux` available for stable authenticated sessions during Aquila terminal calls (desktop app flow only)
...
### Service Account (recommended for Aquila)
...
## Aquila Execution Pattern (desktop app flow)

Aquila terminal commands are non-interactive by default and can lose auth context between calls.
