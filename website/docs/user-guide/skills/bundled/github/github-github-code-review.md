...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from Aquila Agent\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Aquila Agent. Code looks clean — good test coverage, no security concerns."
