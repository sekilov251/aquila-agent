---
title: "Petdex — Install and select animated petdex mascots for Aquila"
sidebar_label: "Petdex"
description: "Install and select animated petdex mascots for Aquila"
---
...
Install and select animated petdex mascots for Aquila.
...
the Aquila CLI, TUI, and desktop app. This skill drives the `hermes pets` CLI
...
- Pillow (a core Aquila dependency) for sprite decoding — already installed.
...
- The petdex npm CLI installs to `~/.codex/pets`; Aquila uses its own
