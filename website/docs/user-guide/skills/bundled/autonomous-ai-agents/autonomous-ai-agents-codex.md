...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Aquila terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Aquila itself, `model.provider: openai-codex` uses Aquila-managed Codex
...
## Aquila Gateway Caveat

When invoking the Codex CLI from a Aquila gateway/service context (for example,
