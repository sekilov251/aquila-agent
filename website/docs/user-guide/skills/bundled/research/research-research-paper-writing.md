...
## Aquila Agent Integration

This skill is designed for the Aquila agent. It uses Aquila tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Aquila skills for specific phases:
