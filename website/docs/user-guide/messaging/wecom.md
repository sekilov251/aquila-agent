...
description: "Connect Aquila Agent to WeCom via the AI Bot WebSocket gateway"
---

# WeCom (Enterprise WeChat)

Connect Aquila to [WeCom](https://work.weixin.qq.com/) (企业微信), Tencent's enterprise messaging platform. The adapter uses WeCom's AI Bot WebSocket gateway for real-time bidirectional communication — no public endpoint or webhook needed.
...
Select **WeCom** and scan the QR code with your WeCom mobile app. Aquila will automatically create a bot application with the correct permissions and save the credentials.
