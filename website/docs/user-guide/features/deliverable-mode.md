...
When Aquila Agent runs inside a messaging gateway (Slack, Discord, Telegram,
...
If you use Aquila' kanban multi-agent workflow, workers can attach
...
back into the thread as a native attachment. Aquila Agent's deliverable
