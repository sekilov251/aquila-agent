...
chat completions — use your Aquila-managed provider subscription as their
...
| Use case | "Use Aquila as a chat backend" | "Use my Portal sub from another app" |
...
This opens your browser for the Nous Portal OAuth flow. Aquila stores
the refresh token in `~/.hermes/auth.json` — the same place all Aquila
...
Model:      Aquila-4-70B    # or Aquila-4.3-36B, Aquila-4-405B
```
