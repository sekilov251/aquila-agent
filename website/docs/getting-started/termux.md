...
description: "Run Aquila Agent directly on an Android phone with Termux"
---

# Aquila on Android with Termux
...
Aquila Agent can run directly on an Android phone through [Termux](https://termux.dev/).
...
That does not stop Aquila from working well as a phone-native CLI agent — it just means the recommended mobile install is intentionally narrower than the desktop/server install.

---

## Option 1: One-line installer

Aquila now ships a Termux-aware installer path:
