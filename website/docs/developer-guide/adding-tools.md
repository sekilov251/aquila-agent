...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Aquila Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Aquila tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Aquila core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Aquila Plugin](/developer-guide/plugins)
