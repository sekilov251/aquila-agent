...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Aquila Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Aquila Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Aquila core? Start with [Build a Aquila Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Aquila itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Aquila instance (throwaway HERMES_HOME, separate Electron
