...
React + Ink terminal UI for Aquila. TypeScript owns the screen. Python owns sessions, tools, model calls, and most command logic.
...
tui_gateway/
  ...
  slash_worker.py        persistent AquilaCLI subprocess for slash commands
```
