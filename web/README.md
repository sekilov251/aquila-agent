...
Browser-based dashboard for managing Aquila Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Aquila Agent” — mixed case, no Mondwest, no `text-display` |
